...
/**
 * Class yang digunakan untuk mengatur koneksi ke database Oracle
 *
...
public class OracleJDBC {
     ...
     */
    private static OracleJDBC sInstance = null;
     ...
     */
    private OracleJDBC(String dbName, String userName, String userPassword) {
        this.dbName = dbName;
        this.userName = userName;
        this.userPassword = userPassword;

        try {
            Class.forName("oracle.jdbc.OracleDriver"); // Mencari class driver yang dibutuhkan
     ...
     */
    public static OracleJDBC getsInstance(String dbName, String userName, String userPassword) {
        if (sInstance == null) {
            sInstance = new OracleJDBC(dbName, userName, userPassword);
        }
    ...
    private void setConnection() {
        try {
            connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:" + dbName, userName, userPassword);
